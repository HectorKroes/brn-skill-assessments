...
We can conclude that the location with the highest average ranking in this period is Macao SAR, China. Having already calculated the population density score, we can best visualize it by building a choropleth: 
...
So we can conclude that the location with the greatest increase in life expectancy were the Maldives. And again, to better visualize the bigger picture, we will plot another cloropleth:
