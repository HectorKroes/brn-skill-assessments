...
We can observe the increase in mucin expression in COPD patients. From the nine main human mucin genes, we find that MUC4, MUC5B and MUC5AC are upregulated. MUC5AC is the main gene previously reported overexpressed in COPD patients’ sputum [@chadwick_mucus_2008]. 
...
In our dataset, there’s no distinction for each patient’s COPD aetiology. But after this analysis, we can verify that many representatives of the serpin superfamily are shown to be upregulated in COPD patients, which is the normal physiological reaction to inflammation [@kelly-robinson_serpin_2021], showing that probably our COPD group is mostly represented by individuals without serpin deficiencies. 
